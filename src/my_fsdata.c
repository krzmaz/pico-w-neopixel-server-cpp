...
static const unsigned int dummy_align__res_json = 0;
#endif
static const unsigned char FSDATA_ALIGN_PRE data__res_json[] FSDATA_ALIGN_POST = {
/* /res.json (10 chars) */
0x2f,0x72,0x65,0x73,0x2e,0x6a,0x73,0x6f,0x6e,0x00,0x00,0x00,
...
0x0d,0x0a,
/* raw file data (2 bytes) */
0x7b,0x7d,};



const struct fsdata_file file__res_json[] = { {
file_NULL,
data__res_json,
data__res_json + 12,
sizeof(data__res_json) - 12,
FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT | FS_FILE_FLAGS_HEADER_HTTPVER_1_1,
}};

#define FS_ROOT file__res_json
